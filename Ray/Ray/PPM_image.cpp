...
void random_spheres() {
	...
	auto ground_material = make_shared<lambertian>(make_shared<solid_color>(color(0.5, 0.5, 0.5)));
	...
	auto material2 = make_shared<lambertian>(std::make_shared<solid_color>(0.4, 0.2, 0.1));
